 ...
 *
 * docs/141 4ad (user): the search box the page never had. Same grammar as
...
(function () {
    ...
    /* docs/141 4ab: the key tree. A container row (tr.dp-dir) toggles
       ...
       collapsed (walk data-parent up through a path -> row map) -- or, 4ad,
    ...
    function rowMap(root) {
        ...
        // is its own path, and spin until the guard (4ab, fixed in 4ad).
        var byPath = {};

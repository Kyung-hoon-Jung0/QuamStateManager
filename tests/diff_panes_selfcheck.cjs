 ...
 * docs/141 4ad: the search box -- SearchQuery grammar over path + values,
...
// 4ad: the LIST view got the same box
{
...
// 4ad: a leaf that is ALSO a container shares its path with its own dir row;
...
console.log(fails ? ('FAILED: ' + fails) : 'ALL OK (60 assertions)');
